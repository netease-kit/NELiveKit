网易云信为您提供开源的示例项目，您可以参考本文档快速跑通示例项目，体验直播房的效果。
...
| 环境要求                                                        | 说明                                                      |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
|  iOS 版本  |  13.0 及以上的 iPhone 或者 iPad 真机   |
|  CPU 架构 | ARM64、ARMV7   |
| IDE | XCode   |
| 其他 | 安装 CocoaPods  |
...
1. 克隆[直播房示例项目源码](https://github.com/netease-kit/NELiveKit/tree/main/iOS)仓库至您本地工程。
