...
+ (void)showWithTarget:(id<NETSMoreSettingActionSheetDelegate>)target items:(NSArray <NETSMoreSettingModel *> *)items {
...
- (void)_didActionWithModel:(NETSMoreSettingModel *)model
{
    ...
    switch (model.type) {
        case NETSMoreSettingCamera: {
            ...
            if (_delegate && [_delegate respondsToSelector:@selector(didSelectCameraEnable:)]) {
