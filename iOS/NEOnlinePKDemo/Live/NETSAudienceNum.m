...
/// 安装视图模型
- (void)installWithModel:(NERoomMember *)model indexPath:(NSIndexPath *)indexPath
{
...
/// 创建cell
+ (NETSAudienceNumCell *)cellWithCollectionView:(UICollectionView *)collectionView indexPath:(NSIndexPath *)indexPath datas:(NSArray <NERoomMember *> *)datas
{
...
@property (nonatomic, strong)   NSArray <NERoomMember *>             *datas;
...
- (void)reloadWithDatas:(NSArray <NERoomMember *> *)datas
{
//    NSInteger diff = 5 - [datas count];
//    NSMutableArray *arr = [NSMutableArray array];
//    if (diff > 0) {
//        for (NSInteger i = diff; i > 0; i--) {
//            NERoomMember *member = [[NERoomMember alloc] init];
...
//    }
    ...
    _numLab.text = [NSString stringWithFormat:@"%ld", count - 1];
