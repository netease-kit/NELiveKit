...
@property (nonatomic,strong) NSMutableArray<NETSMessageModel *> *pendingMessages;
@end
...
- (void)addMessages:(NSArray<NETSMessageModel *> *)messages
{
    if (messages.count) {
...
- (void)caculateHeight:(NSArray<NETSMessageModel *> *)messages
{
...
- (void)processPendingMessages
{
    ...
    for (NETSMessageModel *message in insert)
    {
