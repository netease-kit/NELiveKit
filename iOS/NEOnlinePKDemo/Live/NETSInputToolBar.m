...
- (void)addNotificationObserve {
    [NSNotificationCenter.defaultCenter addObserver:self selector:@selector(micApplyCountDidChange:) name:@"audience_applyConnectMic" object:nil]; // 顶部歌曲变化通知
}
...
- (void)layoutSubviews {
    CGFloat inputWidth = self.width - 16 - 3 * 36 - 3 * 10;
