...
typedef NS_ENUM(NSInteger, NELiveStreamPopoverType) {
  NELiveStreamPopoverTypeUp = 0,
  NELiveStreamPopoverTypeDown,
};

@interface NELiveStreamPopoverOption : NSObject
...
@property(nonatomic, assign)
    NELiveStreamPopoverType preferedType;  // just effect when autoAjustDirection = YES; default is
                                           // NELiveStreamPopoverTypeUp;
@property(nonatomic, assign) NELiveStreamPopoverType
    popoverType;  // default is NELiveStreamPopoverTypeUp; not effect when autoAjustDirection = YES;
