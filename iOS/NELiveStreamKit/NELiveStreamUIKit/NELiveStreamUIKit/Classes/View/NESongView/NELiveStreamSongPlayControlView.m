...
@interface NELiveStreamSongPlayControlView ()
...
@implementation NELiveStreamSongPlayControlView
...
- (void)setIsPlaying:(BOOL)isPlaying {
  ...
  if (isPlaying) {
    [self.pauseBtn setImage:[NELiveStreamUI ne_livestream_imageName:@"pause_ico"]
                   forState:UIControlStateNormal];
  } else {
    [self.pauseBtn setImage:[NELiveStreamUI ne_livestream_imageName:@"resume_ico"]
                   forState:UIControlStateNormal];
  }
}
...
- (UIButton *)pauseBtn {
  if (!_pauseBtn) {
    ...
    if (self.isPlaying) {
      [_pauseBtn setImage:[NELiveStreamUI ne_livestream_imageName:@"pause_ico"]
                 forState:UIControlStateNormal];
    } else {
      [_pauseBtn setImage:[NELiveStreamUI ne_livestream_imageName:@"resume_ico"]
                 forState:UIControlStateNormal];
    }
...
- (UIButton *)nextBtn {
  if (!_nextBtn) {
    ...
    [_nextBtn setImage:[NELiveStreamUI ne_livestream_imageName:@"next_ico"]
              forState:UIControlStateNormal];
...
- (UIImageView *)speakerImageView {
  if (!_speakerImageView) {
    _speakerImageView =
        [[UIImageView alloc] initWithImage:[NELiveStreamUI ne_livestream_imageName:@"speaker_ico"]];
  }
...
- (UISlider *)volumeSlider {
  if (!_volumeSlider) {
    ...
    [_volumeSlider setThumbImage:[NELiveStreamUI ne_livestream_imageName:@"slider_thumb"]
                        forState:UIControlStateNormal];
  }
