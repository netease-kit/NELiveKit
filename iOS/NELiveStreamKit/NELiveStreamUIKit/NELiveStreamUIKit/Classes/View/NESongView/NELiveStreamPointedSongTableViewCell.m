...
@interface NELiveStreamPointedSongTableViewCell ()

@end

@implementation NELiveStreamPointedSongTableViewCell
...
- (void)initView {
  ...
  self.playingImageView.image = [NELiveStreamUI ne_livestream_imageName:@"pointsong_playing"];
  ...
  [self.cancelButton setImage:[NELiveStreamUI ne_livestream_imageName:@"listenTogether_cancel"]
