...
- (void)micQueueConnectBtnPressedWithMicInfo:(NELiveStreamSeatItem *)micInfo;
...
/// 主播信息
@property(nonatomic, strong) NELiveStreamSeatItem *anchorMicInfo;
/// 麦位信息
@property(nonatomic, strong) NSArray<NELiveStreamSeatItem *> *datas;
/// 礼物信息
@property(nonatomic, strong) NSMutableArray<NELiveStreamBatchSeatUserReward *> *giftDatas;

/**
 更新麦位信息
 @param micInfo - 麦位信息
 */
- (void)updateCellWithMicInfo:(NELiveStreamSeatInfo *)micInfo;
