...
@interface NELiveStreamGiftNumCell ()
@property(nonatomic, strong) UILabel *info;
@property(nonatomic, strong) UIView *foreCoverView;

@end
@implementation NELiveStreamGiftNumCell
...
+ (NELiveStreamGiftNumCell *)cellWithTableView:(UITableView *)tableView
                                     indexPath:(NSIndexPath *)indexPath
                                 currentNumber:(NSString *)number
                                         datas:(NSArray *)datas {
  NELiveStreamGiftNumCell *cell =
      [tableView dequeueReusableCellWithIdentifier:NELiveStreamGiftNumCell.description
