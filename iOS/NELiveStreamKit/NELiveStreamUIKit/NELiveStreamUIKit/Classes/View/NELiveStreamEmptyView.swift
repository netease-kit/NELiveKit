...
@objcMembers public class NELiveStreamEmptyView: UIView {
  ...
  lazy var imgView: UIImageView = {
    ...
    view.image = NELiveStreamUI.ne_livestream_imageName("live_empty_icon")
    return view
  }()
  ...
  lazy var tipLabel: UILabel = {
    ...
    view.text = NELiveStreamBundle.localized("Audience_Apply_List_Empty")
