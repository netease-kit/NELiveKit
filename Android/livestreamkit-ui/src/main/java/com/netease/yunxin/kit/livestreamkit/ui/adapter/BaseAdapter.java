...
public abstract class BaseAdapter<T> extends RecyclerView.Adapter {
  ...
  private void onClickInner(View itemView) {
    ...
    T model = (T) itemView.getTag(R.id.live_base_adapter_model_tag);
    int position = (int) itemView.getTag(R.id.live_base_adapter_position_tag);
  ...
  public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
    ...
    holder.itemView.setTag(R.id.live_base_adapter_model_tag, dataList.get(position));
    holder.itemView.setTag(R.id.live_base_adapter_position_tag, position);
  }
