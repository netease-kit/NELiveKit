...
public class HeadImageView extends CircleImageView {
  ...
  public static final int DEFAULT_AVATAR_THUMB_SIZE =
      (int) Utils.getApp().getResources().getDimension(R.dimen.live_avatar_size_default);
  private static final int DEFAULT_AVATAR_RES_ID = R.drawable.live_nim_avatar_default;
