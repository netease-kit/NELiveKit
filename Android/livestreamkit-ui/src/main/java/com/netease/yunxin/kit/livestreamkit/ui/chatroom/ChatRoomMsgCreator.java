...
package com.netease.yunxin.kit.livestreamkit.ui.chatroom;
...
public class ChatRoomMsgCreator {
  ...
  public static CharSequence createRoomEnter(String userNickName) {
    return new ChatMessageSpannableStr.Builder()
        ...
        .append(" ")
        .append(Utils.getApp().getString(R.string.live_enter_room), HIGH_COLOR)
        .build()
        .getMessageInfo();
  }
  ...
  public static CharSequence createRoomExit(String userNickName) {
    return new ChatMessageSpannableStr.Builder()
        .append(userNickName, HIGH_COLOR)
        .append(" ")
        .append(Utils.getApp().getString(R.string.live_leave_room), HIGH_COLOR)
        .build()
        .getMessageInfo();
  }
  ...
  public static CharSequence createGiftReward(
    ...
    return new ChatMessageSpannableStr.Builder()
        .append(userNickName, HIGH_COLOR)
        .append(": ", HIGH_COLOR)
        .append(Utils.getApp().getString(R.string.live_donate) + " × ", COMMON_COLOR)
        .append(String.valueOf(giftCount), COMMON_COLOR)
        .append(Utils.getApp().getString(R.string.live_count), COMMON_COLOR)
        .append(" ")
