...
import com.netease.yunxin.kit.voiceroomkit.api.model.NELiveConfig
    ...
    fun voiceRoomInfo2NEVoiceRoomInfo(voiceRoomInfo: VoiceRoomInfo): NEVoiceRoomInfo {
        return NEVoiceRoomInfo(
            ...
            NEVoiceRoomLiveModel(
                ...
                voiceRoomInfo.liveModel.externalLiveConfig?.let {
                    NELiveConfig(
                        voiceRoomInfo.liveModel.externalLiveConfig?.pullHlsUrl,
                        voiceRoomInfo.liveModel.externalLiveConfig?.pullRtmpUrl,
                        voiceRoomInfo.liveModel.externalLiveConfig?.pullHlsUrl
                    )
                },
