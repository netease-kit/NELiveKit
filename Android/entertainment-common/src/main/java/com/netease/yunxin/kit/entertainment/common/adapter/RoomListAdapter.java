...
public class RoomListAdapter extends RecyclerView.Adapter<RoomListAdapter.RoomViewHolder> {
  ...
  private final List<LiveInfo> roomInfoList;
  ...
  public void refreshList(List<LiveInfo> dataList) {
    roomInfoList.clear();
    roomInfoList.addAll(dataList);
    notifyDataSetChanged();
  }

  public void loadMore(List<LiveInfo> dataList) {
    roomInfoList.addAll(dataList);
    notifyDataSetChanged();
  }
  ...
  public void onBindViewHolder(@NonNull RoomViewHolder holder, int position) {
    LiveInfo roomInfo = roomInfoList.get(position);
  ...
  public static class RoomViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setData(LiveInfo info) {
      ...
      binding.tvChatRoomAnchorName.setText(info.getNick());
