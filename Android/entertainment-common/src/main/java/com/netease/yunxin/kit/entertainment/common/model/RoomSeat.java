...
public class RoomSeat implements Serializable, Parcelable {
  ...
  private final NERoomMember member;
  ...
  public RoomSeat(int index, int status, int reason, NERoomMember member) {
    this.index = index;
    this.status = status;
    this.reason = reason;
    this.member = member;
  ...
  public RoomSeat(int index, int status, int reason, NERoomMember member, int rewardTotal) {
    this.index = index;
    this.status = status;
    this.reason = reason;
    this.member = member;
  ...
  public void writeToParcel(Parcel dest, int flags) {
    ...
    dest.writeSerializable(member.getUuid());
  }
  ...
  public boolean isSameAccount(String account) {
    return !TextUtils.isEmpty(account) && member != null && account.equals(member.getUuid());
  }
