...
import com.netease.yunxin.kit.entertainment.common.utils.ChatMessageSpannableStr;
...
public class ChatRoomMsgCreator {
  ...
  public static CharSequence createText(
    ...
    if (isAnchor) {
      int width = SizeUtils.dp2px(30f);
      int height = SizeUtils.dp2px(15f);
  ...
  public static CharSequence createGiftReward(
    ...
    int gifSize = SizeUtils.dp2px(22f);
    return new ChatMessageSpannableStr.Builder()
        .append(userNickName, HIGH_COLOR)
        .append(": ", HIGH_COLOR)
        .append(
