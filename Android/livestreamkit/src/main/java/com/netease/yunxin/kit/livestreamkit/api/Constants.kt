    ...
    companion object {
        fun fromValue(value: String?): NEVoiceRoomEndReason = when (value) {
            ...
            END_OF_RTC.name -> END_OF_RTC
                ...
                LiveRoomLog.e("NEVoiceRoomEndReason", "parse failure， Unable to identify: $value")
                UNKNOWN
            }
        }
    }
    ...
    companion object {
        fun fromValue(value: String?): NEVoiceRoomAuthEvent = when (value) {
            ...
            LOGGED_OUT.name -> LOGGED_OUT
                ...
                LiveRoomLog.e("NEVoiceRoomAuthEvent", "parse failure， Unable to identify: $value")
                LOGGED_OUT
            }
        }
    }
 ...
 * @constructor
 */
enum class NELiveRoomLiveState(val value: Int) {
    /**
     * 未开始
     */
    NotStart(0),
 ...
 * 上麦模式
 */
object NELiveRoomSeatApplyMode {
    /**
     * 自由上麦模式
     */
    const val free = 0
 ...
 * 邀请上麦模式
 */
object NELiveRoomSeatInviteMode {
    /**
     * 抱麦时不需要对方同意
     */
    const val noNeedAgree = 0
