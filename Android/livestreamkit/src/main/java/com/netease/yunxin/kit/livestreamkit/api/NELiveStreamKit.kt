...
interface NELiveStreamKit {
    ...
    companion object {
        ...
        @JvmField
        val instance: NELiveStreamKit = LiveStreamKitImpl()
         ...
         */
        @JvmStatic
        fun getInstance(): NELiveStreamKit = instance
    }
     ...
     * 加入房间后获取
     */
    val localMember: NERoomMember?

    /**
     * 所有成员（包括本端）
     * 加入房间后获取
     */
    val allMemberList: List<NERoomMember>

    /**
     * NEVoiceRoomKit 初始化
     *
     * @param context 上下文
     * @param config 初始化配置 [NELiveStreamKitConfig]
     * @param callback 回调
     */
    fun initialize(
        context: Context,
        config: NELiveStreamKitConfig,
        callback: NELiveStreamCallback<Unit>? = null
    )
     ...
     *
     */
    fun addAuthListener(listener: NEAuthListener)

    /**
     * 移除登录状态监听
     * @param listener 监听器
     */
    fun removeAuthListener(listener: NEAuthListener)
     ...
     *
     */
    fun addLiveStreamListener(listener: NELiveStreamListener)
     ...
     *
     */
    fun removeLiveStreamListener(listener: NELiveStreamListener)
     ...
     * @param callback 回调
     * <br>相关回调：登录成功后，会触发[NELiveRoomAuthListener.onLiveRoomAuthEvent]回调
     */
    fun login(account: String, token: String, callback: NELiveStreamCallback<Unit>? = null)

    /**
     * 登出
     *
     * @param callback 回调
     * <br>相关回调：登出成功后，会触发[NELiveRoomAuthListener.onLiveRoomAuthEvent]回调
     */
    fun logout(callback: NELiveStreamCallback<Unit>? = null)
    ...
    fun getLiveRoomList(
        ...
        pageNum: Int,
        pageSize: Int,
        callback: NELiveStreamCallback<NELiveRoomList>? = null
    )

    /**
     * 创建房间
     * <br>使用前提：该方法仅在调用[login]方法登录成功后调用有效
     * @param params 创建房间参数配置[NECreateLiveRoomParams]
     * @param options 进入房间时的必要配置[NECreateLiveRoomOptions]
     * @param callback 回调
     * <br>注意事项：只有房主能执行该操作
     */
    fun createRoom(
     ...
     * @param callback 回调
     */
    fun getCreateRoomDefaultInfo(callback: NELiveStreamCallback<NECreateLiveRoomDefaultInfo>)
    ...
    fun resumeLive(callback: NELiveStreamCallback<Unit>?)

    /**
     * 离开房间
     * <br>使用前提：该方法仅在调用[joinRoom]方法加入房间成功后调用有效
     * @param callback 回调
     * <br>相关回调：离开房间成功后，会触发[NELiveStreamListener.onMemberLeaveRoom]回调
     */
    fun leaveRoom(callback: NELiveStreamCallback<Unit>? = null)
     ...
     * <br>使用前提：该方法仅在调用[login]方法登录成功后调用有效
     * @param callback 回调
     * <br>相关回调：离开房间成功后，会触发[NELiveStreamListener.onLiveEnded]回调
     * <br>注意事项：只有房主能执行该操作
     */
    fun endRoom(callback: NELiveStreamCallback<Unit>? = null)
     ...
     *
     */
    fun getSeatInfo(callback: NELiveStreamCallback<NESeatInfo>? = null)
     ...
     *
     */
    fun getSeatRequestList(callback: NELiveStreamCallback<List<NELiveRoomSeatRequestItem>>? = null)
     ...
     * @param callback 回调。
     * <br>相关回调：邀请上麦后，观众同意后（组件默认自动接收邀请），房间内所有成员会触发[NELiveStreamListener.onSeatInvitationAccepted]回调和[NELiveStreamListener.onSeatListChanged]回调
     */
     ...
     * <br>使用前提：该方法仅在调用[login]方法登录成功后调用有效
     * @param callback 回调。
     * <br>相关回调：邀请上麦后，观众同意后（组件默认自动接收邀请），房间内所有成员会触发[NELiveStreamListener.onSeatInvitationRejected]回调
     */
    fun rejectSeatInvitation(
        callback: NELiveStreamCallback<Unit>? = null
    )
     ...
     * @param callback 回调。
     * <br>相关回调：申请上麦后，房间内所有成员会触发[NELiveStreamListener.onSeatRequestSubmitted]回调和[NELiveStreamListener.onSeatListChanged]回调
     */
     ...
     * <br>使用前提：该方法仅在调用[login]方法登录成功后调用有效
     * @param callback 回调
     * <br>相关回调：取消申请上麦后，房间内所有成员会触发[NELiveStreamListener.onSeatRequestCancelled]回调和[NELiveStreamListener.onSeatListChanged]回调
     * <br>注意事项：只有非房主能执行该操作
     */
    fun cancelSeatRequest(callback: NELiveStreamCallback<Unit>? = null)
     ...
     * @param callback 回调
     * <br>相关回调：房主同意申请上麦后，房间内所有成员会触发[NELiveStreamListener.onSeatRequestApproved]回调和[NELiveStreamListener.onSeatListChanged]回调
     * <br>注意事项：只有房主能执行该操作
     */
    fun approveSeatRequest(account: String, callback: NELiveStreamCallback<Unit>? = null)
     ...
     * @param callback 回调
     * <br>相关回调：房主拒绝申请上麦后，房间内所有成员会触发[NELiveStreamListener.onSeatRequestRejected]回调和[NELiveStreamListener.onSeatListChanged]回调
     * <br>注意事项：只有房主能执行该操作
     */
    fun rejectSeatRequest(account: String, callback: NELiveStreamCallback<Unit>? = null)
     ...
     * @param callback 回调
     * <br>相关回调：房主踢麦后，房间内所有成员会触发[NELiveStreamListener.onSeatKicked]回调和[NELiveStreamListener.onSeatListChanged]回调
     * <br>注意事项：只有房主能执行该操作
     */
    fun kickSeat(account: String, callback: NELiveStreamCallback<Unit>? = null)

    /**
     * 下麦
     * <br>使用前提：该方法仅在调用[login]方法登录成功后调用有效
     * @param callback 回调
     * <br>相关回调：房主踢麦后，房间内所有成员会触发[NELiveStreamListener.onSeatLeave]回调和[NELiveStreamListener.onSeatListChanged]回调
     */
    fun leaveSeat(callback: NELiveStreamCallback<Unit>? = null)
     ...
     * @param callback 回调
     * <br>注意事项：只有房主能执行该操作
     * <br>相关回调：禁用指定成员音频后，房间内所有成员会触发[NELiveStreamListener.onMemberAudioBanned]回调
     */
    fun banRemoteAudio(account: String, callback: NELiveStreamCallback<Unit>? = null)
     ...
     * @param callback 回调
     * <br>注意事项：只有房主能执行该操作
     * <br>相关回调：解禁指定成员的音频后，房间内所有成员会触发[NELiveStreamListener.onMemberAudioBanned]回调
     */
    fun unbanRemoteAudio(account: String, callback: NELiveStreamCallback<Unit>? = null)
     ...
     * @param callback 回调
     * <br>注意事项：只有房主能执行该操作
     * <br>相关回调：打开麦位后，房间内所有成员会触发[NELiveStreamListener.onSeatListChanged]回调
     */
    fun openSeats(seatIndices: List<Int>, callback: NELiveStreamCallback<Unit>? = null)
     ...
     * @param callback 回调
     * <br>注意事项：只有房主能执行该操作
     * <br>相关回调：关闭麦位后，房间内所有成员会触发[NELiveStreamListener.onSeatListChanged]回调
     */
    fun closeSeats(seatIndices: List<Int>, callback: NELiveStreamCallback<Unit>? = null)
     ...
     * @param content 消息内容
     * @param callback 回调
     * <br>相关回调：调用改方法后，房间内其他成员都会触发[NELiveStreamListener.onReceiveTextMessage]回调
     */
    fun sendTextMessage(content: String, callback: NELiveStreamCallback<NERoomChatMessage>? = null)

    /**
     * 关闭自己的麦克风
     * <br>使用前提：该方法仅在调用[login]方法登录成功且上麦成功后调用有效
     * @param callback 回调
     * <br>相关回调：调用该方法后，本端和其他上麦用户会触发[NELiveStreamListener.onMemberAudioMuteChanged]回调
     */
    fun muteMyAudio(callback: NELiveStreamCallback<Unit>? = null)
     ...
     * <br>相关回调：调用该方法后，本端和其他上麦用户会触发[NELiveStreamListener.onMemberAudioMuteChanged]回调
     */
    fun unmuteMyAudio(callback: NELiveStreamCallback<Unit>? = null)
     ...
     * <br>相关回调：调用该方法后，本端和其他上麦用户会触发[NELiveStreamListener.onMemberAudioMuteChanged]回调
     */
    fun muteMyVideo(callback: NELiveStreamCallback<Unit>? = null)
     ...
     * <br>相关回调：调用该方法后，本端和其他上麦用户会触发[NELiveStreamListener.onMemberAudioMuteChanged]回调
     */
    fun unmuteMyVideo(callback: NELiveStreamCallback<Unit>? = null)
     ...
     * SDK 都会在加入房间后根据预设的时间间隔触发 [NELiveStreamListener.onRtcRemoteAudioVolumeIndication] 回调
     ...
     */
    fun authenticate(name: String, cardNo: String, callback: NELiveStreamCallback<Unit>? = null)
     ...
     * @return 0：方法调用成功。其他：方法调用失败
     */
    fun startLastmileProbeTest(config: NERoomRtcLastmileProbeConfig): Int
     ...
     * @param language 目标语言
     */
    fun switchLanguage(language: NERoomLanguage): Int
}
 ...
 */
data class NELiveStreamKitConfig(val appKey: String, val extras: Map<String, Any?> = mapOf()) {
 ...
 * @param T 数据
 */
interface NELiveStreamCallback<T> {
    /**
     * 成功回调
     * @param t 数据
     */
