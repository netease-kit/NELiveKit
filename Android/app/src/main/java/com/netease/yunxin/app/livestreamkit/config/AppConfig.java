...
package com.netease.yunxin.app.livestreamkit.config;
...
public class AppConfig {
  private static final String APP_KEY =
      "your AppKey"; // 请填写应用对应的AppKey，可在云信控制台的”AppKey管理“页面获取
  ...
  public static final String BASE_URL = "https://yiyong-qa.netease.im/"; //云信派对服务端国内的体验地址
